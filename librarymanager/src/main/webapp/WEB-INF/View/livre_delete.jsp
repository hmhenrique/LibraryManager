  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du livre n°${livre.id}</h5> <!-- TODO : afficher l'id du livre au lieu de 42 -->
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer le livre ${livre.titre} de ${livre.auteur} (code ${livre.ISBN}) ?</p> <!-- TODO : compl�ter les trois informations ci-contre -->
	      <form action="livre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="livre_details?id=${livre.id}">Annuler</a> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        </div>
	      </form>
	    </div>	    
      </div>
