  ...
  <main>
    <section class="content">
      ...
      <h5>Détails du membre n°${membre.id}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="membre_details?id=${membre.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
          ...
          <div class="col s12">
	        <table class="striped">
              ...
              <tbody id="results">
				...
				<c:if test="${!actuelEmprunts.isEmpty()}">
					<c:forEach items="${actuelEmprunts}" var="emprunt">
						<tr>
